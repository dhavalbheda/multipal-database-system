<%@ Page EnableTheming="false" Theme="Whity" Language="C#" AutoEventWireup="true" CodeFile="DatabaseConfiguration.aspx.cs" Inherits="DatabaseConfiguration" %>
                            ...
                            <tr>
                                <td width="15%" class="ConfigurationTab" align="center" valign="middle">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:RadioButtonList ID="DatabaseProvider_RadioButtonList" runat="server" 
                                                AutoPostBack="True" CellSpacing="20" Font-Bold="True" Font-Italic="True" 
                                                Font-Names="Helvetica" Font-Size="Medium" Font-Underline="False" 
                                ...
                                <td align="center" valign="middle">
                                    <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                                        <ContentTemplate>
                                            <asp:Panel ID="XamppPath_Panel" runat="server" Visible="false">
                                            <center>
                                                <asp:Label ID="Label1" runat="server" 
                                                    Text="Xampp Installation Directroy Path : " CssClass="Configuration_Form"></asp:Label>
                                                &nbsp;&nbsp;&nbsp;
                                                <asp:TextBox ID="XamppPath_TextBox" runat="server" Columns="30" 
                                                    CssClass="Configuration_Form"></asp:TextBox>
                                            </center>
                                            </asp:Panel>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                        ...
                                        <tr align="center">
                                            <td class="style3">
                                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Button ID="Clear_Button" runat="server" CssClass="FormButton button" 
                                                            onclick="Clear_Button_Click" Text="Clear" />
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </td>
                                            <td class="style1">
                                                <asp:Button ID="TestConnection_Button" runat="server" CssClass="FormButton button" 
                                                    onclick="TestConnection_Button_Click" Text="Test Connection" />
                                            </td>
                                            <td class="style2">
                                                <asp:Button ID="Save_Button" runat="server" CssClass="FormButton button" 
